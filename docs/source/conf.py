...
sys.path.insert(0, os.path.abspath('../src/grid20m'))
#sys.path.insert(0, os.path.abspath('../src'))
# sys.path.insert(0, os.path.abspath('.'))
...
from grid20m import __version__
...
man_pages = [(master_doc, "grid20m", "grid20m Documentation", [author], 1)]
